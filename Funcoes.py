...
def nivel_estoque(codigo_material):

    if codigo_material <1:
        nivel_estoque = 'Sem Estoque'
    elif codigo_material <10:
        nivel_estoque = 'Baixo Estoque'
    elif codigo_material >= 10 and codigo_material <= 20:
        nivel_estoque = 'Estoque'
    else:
        codigo_material >20: 'Alto Estoque'
